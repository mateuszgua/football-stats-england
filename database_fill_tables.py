...
class DatabaseFillTables:
    ...
    def fill_referees(self):
        ...
        self.db.sql_execute_many_1(sql, referee_list)
    ...
    def fill_clubs(self):
        ...
        self.db.sql_execute_many_1(sql, club_list)
    ...
    def fill_games(self):
        ...
        self.db.sql_execute_many_1(sql, games_list)
    ...
    def fill_bets(self):
        ...
        self.db.sql_execute_many_1(sql, bet_list)

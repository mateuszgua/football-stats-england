...
class DatabaseFillTables:
    ...
    def fill_referees(self):
        ...
        self.db.sql_execute_many(sql, referee_list)
    ...
    def fill_clubs(self):
        ...
        self.db.sql_execute_many(sql, club_list)
    ...
    def fill_games(self):
        ...
        self.db.sql_execute_many(sql, games_list)
    ...
    def fill_bets(self):
        ...
        self.db.sql_execute_many(sql, bet_list)
